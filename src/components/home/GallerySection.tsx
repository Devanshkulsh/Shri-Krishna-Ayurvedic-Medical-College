...
export default function GallerySection() {
  return (
    <section className="overflow-hidden bg-[linear-gradient(135deg,rgba(15,175,59,0.06),rgba(255,255,255,1),rgba(139,195,74,0.08))] px-4 py-20 md:py-28">
      <div className="relative mx-auto max-w-7xl">
        <div className="relative z-10 mb-16 text-center md:mb-20">
          ...
          <h2 className="mb-6 text-4xl font-bold leading-tight tracking-tight text-dark md:text-6xl">
        ...
        <div className="group/nav relative px-2">
          ...
          >
            {galleryItems.map((item, index) => (
              <SwiperSlide
                ...
                className="max-w-75 md:max-w-105"
              >
                <div className="group relative aspect-4/5 overflow-hidden rounded-[2.5rem] border-[6px] border-white bg-light shadow-[0_20px_50px_rgba(26,26,26,0.16)] transition-all duration-500">
                  ...
                  <div className="absolute right-0 bottom-0 left-0 p-8 md:p-10">
                    <p className="mb-2 text-xl font-bold leading-tight tracking-tight text-white md:text-2xl">
                      {item.title}
                    </p>
          ...
          <div className="absolute right-0 bottom-0 left-0 z-20 flex translate-y-3 items-center justify-center gap-8">
            <button
              className="gallery-prev flex h-14 w-14 items-center justify-center rounded-full border border-primary/20 bg-white text-dark shadow-xl transition-all hover:-translate-x-1 hover:bg-primary hover:text-white active:scale-95"
              aria-label="Previous slide"
            >
              <ChevronLeft size={28} strokeWidth={2.5} />
            </button>
            <button
              className="gallery-next flex h-14 w-14 items-center justify-center rounded-full border border-primary/20 bg-white text-dark shadow-xl transition-all hover:translate-x-1 hover:bg-primary hover:text-white active:scale-95"
