...
export default function SectionHeading({
  ...
  return (
    <header className={`border-b border-dark/10 pb-8 md:pb-12 ${className}`}>
      ...
      <div className="mt-4 grid gap-8 md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] md:items-end">
        <h1 className="max-w-4xl text-2xl font-bold leading-tight tracking-tight text-dark sm:text-3xl md:text-5xl">
          {title}
        </h1>
        {description ? (
